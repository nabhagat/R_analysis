...
max_ses4 = 8;
max_ses5 = 8;
Subject_names = {'ERWS','PLSH','BNBO','LSGR'};
Sess_nums = 4:5;

plot_intent_fpr_min = 1;
plot_num_attempts = 0;
%%
% figure();
...
%             print -dtiff -r450 All_subjects_block_accuracy_modified.tif
%             saveas(gca,'All_subjects_block_accuracy_modified.fig')
end
